...
|-------|------|------|-------------|--------|
| Qwen Image 2512 BF16 | `qwen_image_2512_bf16.safetensors` | 13.5 GB | `ComfyUI/models/diffusion_models/qwen/` | [Comfy-Org/Qwen-Image_ComfyUI](https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_2512_bf16.safetensors) |
...
| Qwen Lightning 4-step FP32 LoRA | `Qwen-Image-2512-Lightning-4steps-V1.0-fp32.safetensors` | 1 GB | `ComfyUI/models/loras/qwen/` | [lightx2v/Qwen-Image-2512-Lightning](https://huggingface.co/lightx2v/Qwen-Image-2512-Lightning/resolve/main/Qwen-Image-2512-Lightning-4steps-V1.0-fp32.safetensors) |
