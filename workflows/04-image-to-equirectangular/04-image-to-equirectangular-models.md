...
| Mickmumpitz QWEN-EDIT_360 LoRA | ~295 MB | `ComfyUI/models/loras/qwen/Mickmumpitz360.safetensors` | [mickmumpitz/QWEN-EDIT_360](https://huggingface.co/mickmumpitz/QWEN-EDIT_360) — MIT license |
...
> The Mickmumpitz QWEN-EDIT_360 LoRA is the key ingredient here — without it, outpainting doesn't produce a correct equirectangular projection.
