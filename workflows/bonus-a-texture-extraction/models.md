# Models — Bonus A: Texture Extraction
...
| Qwen Lightning 8-step LoRA | `Qwen-Image-Lightning-8steps-V2.0.safetensors` | ~1.7 GB | `ComfyUI/models/loras/qwen/` | [lightx2v/Qwen-Image-Lightning](https://huggingface.co/lightx2v/Qwen-Image-Lightning/resolve/main/Qwen-Image-Lightning-8steps-V2.0.safetensors) |
| Extract Texture LoRA | `extract_texture_qwen_image_edit_2509.safetensors` | 500 MB | `ComfyUI/models/loras/qwen/` | [tarn59/extract_texture_qwen_image_edit_2509](https://huggingface.co/tarn59/extract_texture_qwen_image_edit_2509/resolve/main/extract_texture_qwen_image_edit_2509.safetensors) |

> Shares the Qwen Image Edit 2511 stack with Modules 03, 05, 06, and Bonus B — no re-download if you've run those modules.
