...
|-------|------|------|-------------|--------|
| Qwen Image Layered BF16 | `qwen_image_layered_bf16.safetensors` | 13.5 GB | `ComfyUI/models/diffusion_models/qwen/` | [Comfy-Org/Qwen-Image-Layered_ComfyUI](https://huggingface.co/Comfy-Org/Qwen-Image-Layered_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_layered_bf16.safetensors) |
...
| Qwen Image Layered VAE | `qwen_image_layered_vae.safetensors` | 170 MB | `ComfyUI/models/vae/qwen/` | [Comfy-Org/Qwen-Image-Layered_ComfyUI](https://huggingface.co/Comfy-Org/Qwen-Image-Layered_ComfyUI/resolve/main/split_files/vae/qwen_image_layered_vae.safetensors) |
